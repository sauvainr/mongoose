...
// apply array element getters
var v = value;
	if(value instanceof Array && this.caster && this.caster.instance && Types[this.caster.instance])// == "DBRef"
		{
		var n = [];
		
		for(var i=0,len=value.length;i<len;i++)
			n[i] = this.caster.applyGetters(value[i],scope);
		
		v = n;
		}

  return SchemaType.prototype.applyGetters.call(this, v, scope);
};
